...
all:	$(ONTOLOGY)-$(ONTOLOGY_DATE).html $(ONTOLOGY)-$(ONTOLOGY_DATE).ttl $(ONTOLOGY)-$(ONTOLOGY_DATE).nt  $(ONTOLOGY)-$(ONTOLOGY_DATE).owl #$(ONTOLOGY)-overall-$(ONTOLOGY_DATE).jpg		
	cp -f $(ONTOLOGY)-$(ONTOLOGY_DATE).html ~/public_html/.
...
$(ONTOLOGY)-template2-$(ONTOLOGY_DATE).html: $(ONTOLOGY)-$(ONTOLOGY_DATE)-citations.html $(ONTOLOGY)-template-$(ONTOLOGY_DATE).html
	 m4 -P $(ONTOLOGY)-template-$(ONTOLOGY_DATE).html > $(ONTOLOGY)-template2-$(ONTOLOGY_DATE).html
$(ONTOLOGY)-$(ONTOLOGY_DATE).html: $(ONTOLOGY)-$(ONTOLOGY_DATE).owl $(ONTOLOGY)-template2-$(ONTOLOGY_DATE).html $(ONTOLOGY)-$(ONTOLOGY_DATE)-citations.html# $(ONTOLOGY)-overall-$(ONTOLOGY_DATE).jpg
	specgen2.py $(ONTOLOGY)-$(ONTOLOGY_DATE).owl $(ONTOLOGY) $(ONTOLOGY)-template2-$(ONTOLOGY_DATE).html  $(ONTOLOGY)-$(ONTOLOGY_DATE).html  -i
...
$(ONTOLOGY)-$(ONTOLOGY_DATE)-citations.html:     $(ONTOLOGY).bib
	bibtex2html -nodoc -nobibsource -unicode --quiet -o - $(ONTOLOGY).bib  | sed "s/<\/table><hr><p><em>This file was generated by/<\/table>/" | head -n -1 > $(ONTOLOGY)-$(ONTOLOGY_DATE)-citations.html
clean:
